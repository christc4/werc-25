...
[iconography](//bauherr.ovh/christos/ico>iconography), and raw meat
...
- <s>rename file</s> [+](/src/werc/#dirdir-file-rename) WIP, can rename current page (21/02/25)
...
- '[search](/src/werc/#searching)': searchbar that searches through all files for instances of text (22/02/25)
